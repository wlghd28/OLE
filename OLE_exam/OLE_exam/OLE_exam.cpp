...
// OLE_exam.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(COLEexamApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &COLEexamApp::OnAppAbout)
...
COLEexamApp::COLEexamApp() noexcept
{
	// 다시 시작 관리자 지원
	...
	SetAppID(_T("OLEexam.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 COLEexamApp 개체입니다.

COLEexamApp theApp;
// 이 식별자는 응용 프로그램에서 통계적으로 고유한 값을 가지도록 생성되었습니다.
// 특정 식별자를 선호할 경우 변경할 수 있습니다.

// {7ebfe870-c1bb-4bf8-878e-d7e7b4a16bba}
static const CLSID clsid =
{0x7ebfe870,0xc1bb,0x4bf8,{0x87,0x8e,0xd7,0xe7,0xb4,0xa1,0x6b,0xba}};


// COLEexamApp 초기화

BOOL COLEexamApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(COLEexamDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(COLEexamView));
	if (!pDocTemplate)
		return FALSE;
	...
	{
		m_server.UpdateRegistry(OAT_INPLACE_SERVER, nullptr, nullptr, FALSE);
		return FALSE;
	}
